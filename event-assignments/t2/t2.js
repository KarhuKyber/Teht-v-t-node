...
restaurants.forEach(restaurant => {
  ...
  tr.addEventListener('click', () => {
    ...
    modal.innerHTML = `
      ...
      <p><strong>Postinumero:</strong> ${restaurant.postalCode}</p>
      <p><strong>Kaupunki:</strong> ${restaurant.city}</p>
      <p><strong>Puhelin:</strong> ${restaurant.phone}</p>
      <p><strong>Yritys:</strong> ${restaurant.company}</p>
      <form method="dialog">
        <button style="margin-top: 10px; padding: 5px 15px;">Sulje</button>
      </form>
    `;
